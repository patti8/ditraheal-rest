...
DELIMITER //
CREATE PROCEDURE `CetakMR4`(IN `PNOPEN` CHAR(10), IN `PKUNJUNGAN` CHAR(19))
BEGIN
		SELECT inst.PPK IDPPK,UPPER(inst.NAMA) NAMAINSTANSI, inst.ALAMAT, inst.KOTA KOTA, INSERT(INSERT(INSERT(LPAD(pp.NORM,8,'0'),3,0,'-'),6,0,'-'),9,0,'-') NORM, pp.NOMOR NOPEN
		     ...
		     , IF(pn.NYERI=1,'Ya','Tidak') NYERI
			  ...
			  , pf.DESKRIPSI NILAIFISIK, ks.MARAH, ks.CEMAS, ks.TAKUT, ks.BUNUH_DIRI, ks.LAINNYA, ks.MASALAH_PERILAKU
			  ...
			  , epk.HAMBATAN_PENDENGARAN, epk.HAMBATAN_PENGLIHATAN, epk.HAMBATAN_KOGNITIF, epk.HAMBATAN_FISIK
			  , epk.HAMBATAN_BUDAYA, epk.HAMBATAN_EMOSI, epk.HAMBATAN_BAHASA, epk.HAMBATAN_LAINNYA, epk.PENERJEMAH
			  , epk.BAHASA, epk.EDUKASI_DIAGNOSA, epk.EDUKASI_PENYAKIT, epk.EDUKASI_REHAB_MEDIK, epk.EDUKASI_HKP
			  , epk.EDUKASI_OBAT, epk.EDUKASI_NYERI, epk.EDUKASI_NUTRISI, epk.EDUKASI_PENGGUNAAN_ALAT
