...
class GabungTagihanResource extends Resource
{
    protected $title = "Gabung Tagihan";

	public function __construct(){
		parent::__construct();
		$this->service = new GabungTagihanService();
	}	
    /**
     * Create a resource
     *
    ...
    {
        $data = $this->service->load(["ID" => $id]);
        if(count($data) > 0) {
            $this->service->batalGabungTagihan($data[0]["KE"]);
            return true;
        }
        return false;
    }
