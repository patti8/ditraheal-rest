...
class TindakanPaketService extends Service
{
    public function __construct() {
        $this->table = DatabaseService::get('SIMpel')->get(new TableIdentifier("tindakan_paket", "master"));
		$this->entity = new TindakanPaketEntity();
    }
