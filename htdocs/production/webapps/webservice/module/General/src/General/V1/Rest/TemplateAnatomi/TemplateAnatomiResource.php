...
class TemplateAnatomiResource extends Resource
{
    protected $title = "Template Anatomi";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT template_anatomi.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
