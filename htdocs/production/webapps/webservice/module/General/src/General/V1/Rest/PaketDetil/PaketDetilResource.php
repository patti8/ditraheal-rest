...
class PaketDetilResource extends Resource
{
    protected $title = "Paket Detil";

	public function __construct() {
		parent::__construct();
		$this->service = new PaketDetilService();
	}
    /**
     * Create a resource
     *
    ...
    public function create($data)
    {
		if(is_array($data->ITEM)) {
            ...
            foreach($data->ITEM as $item) {
                ...
                if($result) {
                    if($result["status"]) $results[] = $result["data"];
                }
            }
            ...
            return [
                ...
                "success" => true,
                "data" => $results,
                "detail" => "Berhasil menyimpan ".$this->title
            ];
        }
