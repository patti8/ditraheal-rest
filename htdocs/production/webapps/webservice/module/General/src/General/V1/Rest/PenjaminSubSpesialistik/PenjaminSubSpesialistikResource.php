...
class PenjaminSubSpesialistikResource extends Resource
{
    protected $title = "Mapping Penjamin Sub Spesialistik";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penjamin_sub_spesialistik.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
