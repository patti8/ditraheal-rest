...
class DokterSMFResource extends Resource
{
    protected $title = "Dokter Spesialis / Subspesialis";

	public function __construct() {
		parent::__construct();
		$this->service = new DokterSMFService();
	}
    /**
     * Create a resource
     *
    ...
    public function create($data)
    {
        ...
        if(count($cek) > 0){
            $record = $cek[0];
            $result = $this->service->simpanData($record);
            return $result;
        }
