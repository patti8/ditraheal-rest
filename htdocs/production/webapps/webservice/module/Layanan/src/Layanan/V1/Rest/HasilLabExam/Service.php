...
class Service extends DBService {
	...
	public function __construct($includeReferences = true, $references = []) {
		$this->config["entityName"] = "Layanan\\V1\\Rest\\HasilLabExam\\HasilLabExamEntity";
		$this->table = DatabaseService::get("SIMpel")->get(new TableIdentifier("hasil_lab_exam", "layanan"));
		$this->entity = new HasilLabExamEntity();
