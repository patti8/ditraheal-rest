...
class Service extends DBService {
	...
	public function __construct($includeReferences = true, $references = []) {
		$this->config["entityName"] = "Layanan\\V1\\Rest\\HasilLabMikroskopik\\HasilLabMikroskopikEntity";
		$this->table = DatabaseService::get("SIMpel")->get(new TableIdentifier("hasil_lab_mikroskopik", "layanan"));
		$this->entity = new HasilLabMikroskopikEntity();
