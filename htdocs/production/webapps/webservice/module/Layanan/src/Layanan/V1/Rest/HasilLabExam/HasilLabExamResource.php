...
class HasilLabExamResource extends Resource
{
    protected $title = "Hasil Pemeriksaan Examination";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
            ...
            foreach($nots as $key => $val) {
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT hasil_lab_exam.".$key." = ".$val.")");
            }
            unset($params["NOT"]);
        }
