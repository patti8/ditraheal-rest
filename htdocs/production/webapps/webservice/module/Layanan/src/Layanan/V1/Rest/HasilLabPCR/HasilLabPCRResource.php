...
class HasilLabPCRResource extends Resource
{
    protected $title = "Hasil Pemeriksaan PCR";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
            ...
            foreach($nots as $key => $val) {
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT hasil_lab_pcr.".$key." = ".$val.")");
            }
            unset($params["NOT"]);
        }
