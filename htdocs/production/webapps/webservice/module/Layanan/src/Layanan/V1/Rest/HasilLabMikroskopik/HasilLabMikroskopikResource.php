...
class HasilLabMikroskopikResource extends Resource
{
    protected $title = "Hasil Mikroskopik";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
            ...
            foreach($nots as $key => $val) {
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT hasil_lab_mikroskopik.".$key." = ".$val.")");
            }
            unset($params["NOT"]);
        }
