...
class PetunjukResource extends Resource
{
    protected $title = "Petunjuk";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT petunjuk.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
