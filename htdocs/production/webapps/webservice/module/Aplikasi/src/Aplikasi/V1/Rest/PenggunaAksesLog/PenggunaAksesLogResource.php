...
class PenggunaAksesLogResource extends Resource
{
    ...
    public function fetch($id)
    {
		...
		$result =  array(
			...
			"detail" => count($data) > 0 ? "Pengguna Akses Log ditemukan" : "Pengguna Akses Log tidak ditemukan"
		);
    ...
    public function fetchAll($params = array())
    {
		...
		return array(
			...
			"total" => $total,
			"data" => $data,
			"detail" => $total > 0 ? "Pengguna Akses Log ditemukan" : "Pengguna Akses Log tidak ditemukan"
		);
    }
