...
class PemeriksaanJariTanganResource extends Resource
{
	protected $title = "Pemeriksaan Jari Tangan";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_jari_tangan.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
