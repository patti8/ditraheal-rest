...
class EdukasiPasienKeluargaResource extends Resource
{
    protected $title = "Edukasi Pasien & Keluarga";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT edukasi_pasien_keluarga.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
