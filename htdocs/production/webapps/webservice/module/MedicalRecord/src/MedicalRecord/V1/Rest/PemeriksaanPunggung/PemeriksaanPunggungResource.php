...
class PemeriksaanPunggungResource extends Resource
{
    protected $title = "Pemeriksaan Punggung";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_punggung.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
