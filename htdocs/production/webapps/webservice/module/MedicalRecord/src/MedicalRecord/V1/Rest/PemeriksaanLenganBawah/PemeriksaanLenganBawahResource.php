...
class PemeriksaanLenganBawahResource extends Resource
{
	protected $title = "Pemeriksaan Lengan Bawah";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_lengan_bawah.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
