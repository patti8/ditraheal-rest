...
class PemeriksaanAnusResource extends Resource
{
    protected $title = "Pemeriksaan Anus";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_anus.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
