...
class PenilaianDekubitusResource extends Resource
{
    protected $title = "Penilaian Dekubitus";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penilaian_dekubitus.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
