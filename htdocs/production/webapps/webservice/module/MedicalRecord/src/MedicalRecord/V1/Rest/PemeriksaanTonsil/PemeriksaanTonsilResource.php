...
class PemeriksaanTonsilResource extends Resource
{
    protected $title = "Pemeriksaan Tonsil";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_tonsil.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
