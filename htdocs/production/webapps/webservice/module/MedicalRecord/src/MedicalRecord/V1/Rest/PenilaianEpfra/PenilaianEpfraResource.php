...
class PenilaianEpfraResource extends Resource
{
    protected $title = "Penilaian Epfra";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penilaian_epfra.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
