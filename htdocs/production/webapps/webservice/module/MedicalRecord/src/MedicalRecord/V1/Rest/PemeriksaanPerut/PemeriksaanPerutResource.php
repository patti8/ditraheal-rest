...
class PemeriksaanPerutResource  extends Resource
{
    protected $title = "Pemeriksaan Perut";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_perut.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
