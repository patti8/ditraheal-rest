...
class EdukasiEmergencyResource extends Resource
{
    protected $title = "Kondisi Sosial";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT edukasi_emergency.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
