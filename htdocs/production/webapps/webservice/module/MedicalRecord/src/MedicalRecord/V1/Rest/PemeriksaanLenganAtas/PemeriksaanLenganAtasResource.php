...
class PemeriksaanLenganAtasResource extends Resource
{
    protected $title = "Pemeriksaan Lengan atas";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_lengan_atas.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
