...
class PemeriksaanBibirResource extends Resource
{
    protected $title = "Pemeriksaan Bibir";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_bibir.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
