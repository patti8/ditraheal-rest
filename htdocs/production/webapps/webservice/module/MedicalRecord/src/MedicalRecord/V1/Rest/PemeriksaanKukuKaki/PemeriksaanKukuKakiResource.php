...
class PemeriksaanKukuKakiResource extends Resource
{
    protected $title = "Pemeriksaan Kuku Kaki";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_kuku_kaki.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
