...
class PemeriksaanPersendianTanganResource extends Resource
{
	protected $title = "Pemeriksaan Persendian Tangan";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_persendian_tangan.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
