...
class PemeriksaanRambutResource extends Resource
{
        protected $title = "Pemeriksaan Rambut";
    ...
    {
        {
            ...
            if (isset($params["NOT"])) {
                ...
                foreach($nots as $key => $val) {                
                    $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_rambut.".$key." = ".$val.")");                
                }
                unset($params["NOT"]);
            }
