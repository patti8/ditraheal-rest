...
class StatusPediatricResource extends Resource
{
    protected $title = "Penilaian Status Pediatric";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT status_pediatric.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
