...
class PemeriksaanKepalaResource  extends Resource
{
    protected $title = "Pemeriksaan Kepala";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_kepala.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
