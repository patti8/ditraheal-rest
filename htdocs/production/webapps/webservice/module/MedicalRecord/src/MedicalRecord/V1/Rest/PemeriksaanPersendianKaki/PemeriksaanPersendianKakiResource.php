...
class PemeriksaanPersendianKakiResource extends Resource
{
	protected $title = "Pemeriksaan Persendian Kaki";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_persendian_kaki.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
