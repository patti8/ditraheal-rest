...
class PemeriksaanGenitalResource extends Resource
{
    protected $title = "Pemeriksaan Genital";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_genital.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
