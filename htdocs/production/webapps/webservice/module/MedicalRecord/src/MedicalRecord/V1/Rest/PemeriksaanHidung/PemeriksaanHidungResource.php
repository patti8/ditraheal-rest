...
class PemeriksaanHidungResource extends Resource
{
    protected $title = "Pemeriksaan Hidung";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_hidung.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
