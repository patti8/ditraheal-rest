...
class StatusFungsionalResource extends Resource
{
    protected $title = "Status Fungsional";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT status_fungsional.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
