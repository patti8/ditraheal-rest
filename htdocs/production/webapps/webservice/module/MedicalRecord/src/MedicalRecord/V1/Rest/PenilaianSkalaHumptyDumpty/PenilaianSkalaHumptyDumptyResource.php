...
class PenilaianSkalaHumptyDumptyResource extends Resource
{
    protected $title = "Penilaian Skala Humpty Dumpty";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penilaian_skala_humpty_dumpty.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
