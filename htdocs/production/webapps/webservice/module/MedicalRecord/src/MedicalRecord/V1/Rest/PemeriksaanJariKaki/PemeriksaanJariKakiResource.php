...
class PemeriksaanJariKakiResource extends Resource
{
    protected $title = "Pemeriksaan Jari Kaki";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_jari_kaki.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
