...
class PemeriksaanGigiGeligiResource extends Resource
{
    protected $title = "Pemeriksaan Gigi Geligi";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_gigi_geligi.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
