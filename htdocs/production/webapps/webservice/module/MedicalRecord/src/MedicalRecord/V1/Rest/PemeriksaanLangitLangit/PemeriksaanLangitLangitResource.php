...
class PemeriksaanLangitLangitResource extends Resource
{
    protected $title = "Pemeriksaan Langit Langit";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_langit_langit.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
