...
class PenilaianSkalaMorseResource extends Resource
{
    protected $title = "Penilaian Skala Morse";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penilaian_skala_morse.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
