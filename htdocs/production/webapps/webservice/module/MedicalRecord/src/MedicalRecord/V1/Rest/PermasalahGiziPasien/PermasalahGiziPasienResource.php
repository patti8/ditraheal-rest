...
class PermasalahGiziPasienResource extends Resource
{
    protected $title = "Permasalahan Gizi Pasien";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT permasalahan_gizi.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
