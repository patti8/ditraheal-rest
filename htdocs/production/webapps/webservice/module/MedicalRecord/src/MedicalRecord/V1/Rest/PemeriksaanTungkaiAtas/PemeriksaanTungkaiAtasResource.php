...
class PemeriksaanTungkaiAtasResource extends Resource
{
    protected $title = "Pemeriksaan Tungkai Atas";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_tungkai_atas.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
