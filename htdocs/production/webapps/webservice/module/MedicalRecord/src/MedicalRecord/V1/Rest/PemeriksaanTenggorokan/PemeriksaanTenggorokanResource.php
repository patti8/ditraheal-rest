...
class PemeriksaanTenggorokanResource extends Resource
{
    protected $title = "Pemeriksaan Tenggorokan";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_tenggorokan.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
