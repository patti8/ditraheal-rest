...
class PemeriksaanTungkaiBawahResource extends Resource
{
    protected $title = "Pemeriksaan Tungkai Bawah";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_tungkai_bawah.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
