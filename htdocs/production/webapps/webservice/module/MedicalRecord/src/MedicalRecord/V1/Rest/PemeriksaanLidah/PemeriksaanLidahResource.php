...
class PemeriksaanLidahResource extends Resource
{
    protected $title = "Pemeriksaan Lidah";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_lidah.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
