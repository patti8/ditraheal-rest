...
class PemeriksaanPayudaraResource extends Resource
{
    protected $title = "Pemeriksaan Payudara";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_payudara.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
