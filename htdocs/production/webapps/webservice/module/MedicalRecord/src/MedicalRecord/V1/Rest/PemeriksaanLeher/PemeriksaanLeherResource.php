...
class PemeriksaanLeherResource extends Resource
{
    protected $title = "Pemeriksaan Leher";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_leher.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
