...
class PemeriksaanKukuTanganResource extends Resource
{
	protected $title = "Pemeriksaan Kuku Tangan";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_kuku_tangan.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
