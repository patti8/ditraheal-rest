...
class RencanaDanTerapiResource extends Resource
{
    protected $title = "Rencana Terapi";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT rencana_terapi.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
