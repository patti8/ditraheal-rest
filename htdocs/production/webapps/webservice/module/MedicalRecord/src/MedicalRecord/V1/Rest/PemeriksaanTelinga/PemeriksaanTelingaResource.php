...
class PemeriksaanTelingaResource extends Resource
{
    protected $title = "Pemeriksaan Telinga";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_telinga.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
