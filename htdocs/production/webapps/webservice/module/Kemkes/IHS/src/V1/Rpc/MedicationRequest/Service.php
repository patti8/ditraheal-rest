...
{    
    ...
    {
        $this->config["entityName"] = "Kemkes\\IHS\\V1\\Rpc\\MedicationRequest\\Entity";
        $this->config["autoIncrement"] = false;
        $this->config["entityId"] = "refId";
        $this->table = DatabaseService::get('SIMpel')->get(new TableIdentifier("medication_request", "kemkes-ihs"));
