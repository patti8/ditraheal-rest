...
class RL4aSebabController extends RPCResource
{
	protected $title = "RL 4a Sebab";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rlempatasebab?".http_build_query($params),
			]);
