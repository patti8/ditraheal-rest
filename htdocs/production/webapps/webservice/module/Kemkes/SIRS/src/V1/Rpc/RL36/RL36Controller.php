...
class RL36Controller extends RPCResource
{
    protected $title = "RL 3.6";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rltigatitikenam?".http_build_query($params),
			]);
