...
class Service extends DBService {
	...
	public function __construct() {
		$this->config["entityName"] = "Kemkes\\SIRS\\V1\\Rpc\\RL51\\Entity";
		$this->config["entityId"] = "object_id";
		$this->table = DatabaseService::get('SIMpel')->get(new TableIdentifier("rl5-1", "kemkes-sirs"));
	}
	...
	public function ambilData($tahun = null) {
	    ...
	    $stmt = $adapter->query('CALL `kemkes-sirs`.ambilDataRL51(?)');
