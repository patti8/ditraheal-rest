...
class RL311Controller extends RPCResource
{
    protected $title = "RL 3.11";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rltigatitiksebelas?".http_build_query($params),
			]);
