...
class RL310Controller extends RPCResource
{
    protected $title = "RL 3.10";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rltigatitiksepuluh?".http_build_query($params),
			]);
