...
class RL53Controller extends RPCResource
{
    protected $title = "RL 5.3";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rllimatitiktiga?".http_build_query($params),
			]);
