...
class RL38Controller extends RPCResource
{
    protected $title = "RL 3.8";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rltigatitikdelapan?".http_build_query($params),
			]);
