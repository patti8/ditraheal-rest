...
class RL34Controller extends RPCResource
{
    protected $title = "RL 3.4";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rltigatitikempat?".http_build_query($params),
			]);
