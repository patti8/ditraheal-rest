...
class Service extends DBService {
	...
	public function __construct() {
		$this->config["entityName"] = "Kemkes\\SIRS\\V1\\Rpc\\RL311\\Entity";
		$this->config["entityId"] = "object_id";
		$this->table = DatabaseService::get('SIMpel')->get(new TableIdentifier("rl3-11", "kemkes-sirs"));
	}
	...
	public function ambilData($tahun = null) {
	    ...
	    $stmt = $adapter->query('CALL `kemkes-sirs`.ambilDataRL311(?)');
