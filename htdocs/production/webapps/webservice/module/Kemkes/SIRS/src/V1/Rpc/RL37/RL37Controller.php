...
class RL37Controller extends RPCResource
{
    protected $title = "RL 3.7";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rltigatitiktujuh?".http_build_query($params),
			]);
