...
class RL33Controller extends RPCResource
{
    protected $title = "RL 3.3";
	...
	public function getList() {
		...
		if(!empty($queries["remote"])) {
			$result = $this->doSendRequest([
				"url" => $this->config['url'],
				"action" => "rltigatitiktiga?".http_build_query($params),
			]);
