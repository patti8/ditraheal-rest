...
class Service extends DBService
{
    ...
    public function __construct($includeReferences = true, $references = array()) {
        $this->table = DatabaseService::get('SIMpel')->get(new TableIdentifier("statistik_10_besar_diagnosa_rujukan", "informasi"));
    ...
    public function simpan($data) {
        ...
        $params = [
            ...
            "JENIS_RUJUKAN" => $this->entity->get("JENIS_RUJUKAN")
        ];
