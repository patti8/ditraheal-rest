...
class ReservasiAntrianResource extends Resource
{
    protected $title = "Reservasi Antrian";
    ...
    public function fetchAll($params = array())
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT reservasi_antrian.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
