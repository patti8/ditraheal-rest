...
class AuditIndividuResource extends Resource
{
    ...
    public function create($data)
    {
        $result = array(
            "status" => 422,
            "success" => false,
            "detail" => "Gagal menyimpan audit individu"
        );
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan audit individu";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "Audit Individu ditemukan" : "Audit Individu tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        $result = array(
            ...
            "success" => false,
            "data" => null,
            "detail" => "Gagal merubah audit individu"
        );
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah audit individu";
            }
        }
