...
class AlasanResource extends Resource
{
    ...
    public function create($data)
    {
        $result = array(
            "status" => 422,
            "success" => false,
            "detail" => "Gagal menyimpan daftar alasan"
        );
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan daftar alasan";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "Daftar alasan ditemukan" : "Daftar alasan tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        $result = array(
            ...
            "success" => false,
            "data" => null,
            "detail" => "Gagal merubah daftar alasan"
        );
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah daftar alasan";
            }
        }
