...
class KegiatanResource extends Resource
{
    ...
    public function create($data)
    {
        $result = array(
            "status" => 422,
            "success" => false,
            "detail" => "Gagal menyimpan kegiatan"
        );
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan kegiatan";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "Kegiatan ditemukan" : "Kegiatan tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah data kegiatan";
            }
        }
