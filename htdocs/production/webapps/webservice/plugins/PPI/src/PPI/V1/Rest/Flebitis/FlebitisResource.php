...
class FlebitisResource extends Resource
{
    ...
    public function create($data)
    {
        $result = array(
            "status" => 422,
            "success" => false,
            "detail" => "Gagal menyimpan flebiti"
        );
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan flebitis";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "Flebitis ditemukan" : "Flebitis tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah flebiti";
            }
        }
