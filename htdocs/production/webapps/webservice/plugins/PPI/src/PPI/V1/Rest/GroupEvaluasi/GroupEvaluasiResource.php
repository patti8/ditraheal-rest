...
class GroupEvaluasiResource extends Resource
{
    ...
    public function create($data)
    {
        $result = array(
            "status" => 422,
            "success" => false,
            "detail" => "Gagal menyimpan group evaluasi"
        );
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan group evaluasi";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "Group Evaluasi ditemukan" : "Group Evaluasi tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        $result = array(
            ...
            "success" => false,
            "data" => null,
            "detail" => "Gagal merubah group evaluasi"
        );
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah data group evaluasi";
            }
        }
