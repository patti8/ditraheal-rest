...
class TindakLanjutResource extends Resource
{
    ...
    public function create($data)
    {
        $result = array(
            "status" => 422,
            "success" => false,
            "detail" => "Gagal menyimpan tindak lanjut"
        );
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan tindak lanjut";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "Tindak lanjut ditemukan" : "Tindak lanjut tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        $result = array(
            ...
            "success" => false,
            "data" => null,
            "detail" => "Gagal merubah tindak lanjut"
        );
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah tindak lanjut";
            }
        }
