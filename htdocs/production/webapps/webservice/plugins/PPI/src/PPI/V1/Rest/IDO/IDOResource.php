...
class IDOResource extends Resource
{
    ...
    public function create($data)
    {
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan IDO";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "IDO ditemukan" : "IDO tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah data IDO";
            }
        }
