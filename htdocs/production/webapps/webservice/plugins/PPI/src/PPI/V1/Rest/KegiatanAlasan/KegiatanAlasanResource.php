...
class KegiatanAlasanResource extends Resource
{
    ...
    public function create($data)
    {
        ...
        if($success) {
            ...
            $result["detail"] = "Berhasil menyimpan alasan";
        }
    ...
    public function fetchAll($params = [])
    {
        ...
        $result =  array(
            ...
            "detail" => count($data) > 0 ? "Alasan ditemukan" : "Alasan tidak ditemukan"
        );
    ...
    public function update($id, $data)
    {
        ...
        if($canUpdate) {
            ...
            if($success) {
                ...
                $result["success"] = true;
                $result["data"] = $success[0];
                $result["detail"] = "Berhasil merubah alasan";
            }
        }
