...
class PengaturanResource extends Resource
{
    ...
    public function create($data)
    {
        $result = array(
			"status" => 422,
			"success" => false,
			"detail" => "Gagal menyimpan Pengaturan"
		);
		...
		if($success) {
			...
			$result["detail"] = "Berhasil menyimpan Pengaturan";
		}
    ...
    public function fetch($id)
    {
		...
		$result =  array(
			...
			"detail" => count($data) > 0 ? "Pengaturan ditemukan" : "Pengaturan tidak ditemukan"
		);
    ...
    public function fetchAll($params = array())
    {
		...
		return array(
			...
			"total" => $total,
			"data" => $data,
			"detail" => $total > 0 ? "Pengaturan ditemukan" : "Pengaturan tidak ditemukan"
		);
    ...
    public function update($id, $data)
    {
        $result = array(
			...
			"success" => false,
			"data" => null,
			"detail" => "Gagal merubah pengaturan registrasi online"
		);
		...
		if($canUpdate) {
			...
			if($success) {
				...
				$result["success"] = true;
				$result["data"] = $success[0];
				$result["detail"] = "Berhasil merubah pengaturan registrasi online";
			}
		}
