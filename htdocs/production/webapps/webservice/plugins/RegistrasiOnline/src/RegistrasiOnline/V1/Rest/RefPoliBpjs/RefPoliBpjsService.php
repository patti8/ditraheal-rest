...
class RefPoliBpjsService extends Service
{   
	public function __construct() {
		$this->table = DatabaseService::get('SIMpel')->get(new TableIdentifier("poli_bpjs", "regonline"));
		$this->entity = new RefPoliBpjsEntity();
    }
