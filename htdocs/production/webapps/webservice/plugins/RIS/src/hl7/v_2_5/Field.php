...
class Field extends AbstractField {	
	protected $fields = [
		 ...
		 *	This column is not used in IHE-profiled HL7 v2.3.1 message
		 */
		"CARDINALITY" => "1..1",
		/* Minimum and maximum number of occurrences for the field in the context of this Transaction.
	...
	public function __construct($seq, $name, $elementName, $description = "-", $value = "", $dt = "ST", $len = 0, $item = "", $opt = Field::OPT_O, $card = "1..1", $tbl = "") {
		$this->fields["SEQ"] = $seq;
