 ...
 * @see https://hl7-definition.caristix.com/v2/HL7v2.4/DataTypes/XPN
 */
...
class PID extends Segment {
	protected function initFields() {
		$this->fields = [
			...
			, new Field(3, "PatientIdentifierList", "Patient Identifier List", "-", "", "CX", 20, "00106", Field::OPT_R)
			, new Field(4, "AlternatePatientID", "Alternate Patient ID", "-", "", "CX", 20, "00107")
			, new Field(5, "PatientName", "Patient Name", "-", "", "XPN", 48, "00108", Field::OPT_R)
			...
			, new Field(8, "Sex", "Sex", "-", "", "IS", 1, "00111", Field::OPT_R, "0001")
			, new Field(9, "PatientAlias", "Patient Alias", "-", "", "XPN", 48, "00112")
			, new Field(10, "Race", "Race", "-", "", "CE", 80, "00113", Field::OPT_RE, "0005")
			, new Field(11, "PatientAddress", "Patient Address", "-", "", "XAD", 106, "00114", Field::OPT_RE)
			...
			, new Field(15, "PrimaryLanguage", "Primary Language", "-", "", "CE", 60, "00118", Field::OPT_O, "0296")
			, new Field(16, "MaritalStatus", "Marital Status", "-", "", "IS", 1, "00119", Field::OPT_O, "0002")
			, new Field(17, "Religion", "Religion", "-", "", "CE", 80, "00120", Field::OPT_O, "0006")
			, new Field(18, "PatientAccountNumber", "Patient Account Number", "-", "", "CX", 20, "00121", Field::OPT_C)
			...
			, new Field(22, "EthnicGroup", "Ethnic Group", "-", "", "CE", 80, "00125", Field::OPT_O, "0189")
			, new Field(23, "BirthPlace", "Birth Place", "-", "", "ST", 60, "00126")
			, new Field(24, "MultipleBirthIndicator", "Multiple Birth Indicator", "-", "", "ID", 1, "00127", Field::OPT_O, "0136")
			, new Field(25, "BirthOrder", "Birth Order", "-", "", "NM", 2, "00128")
			, new Field(26, "Citizenship", "Citizenship", "-", "", "CE", 80, "00129", Field::OPT_O, "0171")
			, new Field(27, "VeteransMilitaryStatus", "Veterans Military Status", "-", "", "CE", 60, "00130", Field::OPT_O, "0172")
			...
			, new Field(30, "PatientDeathIndicator", "Patient Death Indicator", "-", "", "ID", 1, "00741", Field::OPT_O, "0136")
		];
	}
}