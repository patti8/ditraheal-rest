...
class EVN extends Segment {
	protected function initFields() {
		$this->fields = [
			...
			, new Field(1, "EventTypeCode", "Event Type Code", "-", "", "ID", 3, "00099", Field::OPT_O, "0003")
			...
			, new Field(4, "EventReasonCode", "Event Reason Code", "-", "", "IS", 3, "00102", Field::OPT_O, "0062")
			, new Field(5, "OperatorID", "Operator ID", "-", "", "XCN", 60, "00103", Field::OPT_O, "0188")
