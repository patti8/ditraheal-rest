...
class OBX extends Segment {
	protected function initFields() {
		$this->fields = [
			...
			, new Field(2, "ValueType", "Value Type", "-", "", "ID", 2, "00570", Field::OPT_C, "1..1", "0125")
			, new Field(3, "ObservationIdentifier", "Observation Identifier", "-", "", "CE", 250, "00571", Field::OPT_RE)
			, new Field(4, "ObservationSubID", "Observation Sub-ID", "-", "", "ST", 20, "00572", Field::OPT_C)
			, new Field(5, "ObservationValue", "Observation Value", "-", "", "varies", 99999, "00573", Field::OPT_C)
			, new Field(6, "Units", "Units", "-", "", "CE", 250, "00574", Field::OPT_C)
			, new Field(7, "ReferencesRange", "References Range", "-", "", "ST", 60, "00575")
			, new Field(8, "AbnormalFlags", "Abnormal Flags", "-", "", "ID", 5, "00576", Field::OPT_O, "0..1", "0078")
			, new Field(9, "Probability", "Probability", "-", "", "NM", 5, "00577")
			, new Field(10, "NatureOfAbnormalTest", "Nature of Abnormal Test", "-", "", "ID", 2, "00578", Field::OPT_O, "0..1", "0080")
			, new Field(11, "ObserveResultStatus", "Observe Result Status", "-", "", "ID", 1, "00579", Field::OPT_R, "0..1", "0085")
