...
class MSH extends Segment {
	protected function initFields() {
		$this->fields = [
			...
			, new Field(3, "SendingApplication", "Sending Application", "Identifies your application Example: RadiologyInformationSystemName", "", "HD", 180, "00003", Field::OPT_R_PLUS)
			, new Field(4, "SendingFacility", "Sending Facility"
				...
				, "", "HD", 180, "00004", Field::OPT_R_PLUS)
			, new Field(5, "ReceivingApplication", "Receiving Application", "Identifies Practice Fusion as the destination Example: Practice Fusion", "", "HD", 180, "00005", Field::OPT_R_PLUS)
			...
			, new Field(8, "Security", "Security", "Used in some implementations for security features", "", "ST", 40, "00008")
			, new Field(9, "MessageType", "Message Type", "Identifies message type ORU^R01^ORU_R01 / ORM^O01", "", "CM", 13, "00009", Field::OPT_R, "0076/0003")
			...
			, new Field(12, "HL7Version", "HL7 Version", "HL7 Version", "2.3.1", "VID", 60, "00012", Field::OPT_R, "0104")
			...
			, new Field(18, "CharacterSet", "Character Set"
				...
				, " ", "ID", 16, "00692", Field::OPT_C, "0211")
			, new Field(19, "PrincipalLanguageOfMessage", "Principal Language Of Message"
				, "HL7 recommends values from ISO table 639 ".
				  "Example: en for 'English'"
				, "", "CE", 250, "00693")
			, new Field(20, "AlternateCharacterSetHandlingScheme", "Alternate Character Set Handling Scheme", "This field can be left blank", "", "ID", 20, "01317", Field::OPT_O, "0356")
		];
	}
	...
	public function parse($MSHString) {
		...
		foreach($this->fields as $f) {
			$idx++;
			if($idx < 2) continue;
			if(isset($mshs[$idx - 1])) $f->set("VALUE", $mshs[$idx - 1]);			
		}
	}
}